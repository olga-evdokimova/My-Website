(() => {
    ...
    if (document.querySelector(".icon-menu")) document.addEventListener("click", (function() {
    ...
    const myscript_change = document.querySelector(".change");
    const body = document.body;
    let isActive = false;
    ...
    myscript_change.addEventListener("mousedown", (() => {
        isActive = true;
    }));
    ...
    const beforeAfterSlider = x => {
        ...
        myscript_change.style.left = `${shift}px`;
    };
    const pauseEvents = e => {
        e.stopPropagation();
        e.preventDefault();
    ...
    myscript_change.addEventListener("touchstart", (() => {
        isActive = true;
    }));
